...
public class PhoneScreenReceiverEdit {
	...
	public void onReceive(int noAttempt, boolean isCorrectPwd) {
		...
		//Logger logger = Logger.getLogger(PhoneScreenReceiverEdit.class.getName());
		...
		if (isCorrectPwd) {
			...
			if (noAttempt <=3) {
				...
				System.out.println("One last chance before your phone will be locked!!");
			}
			else {
				...
				System.out.println("The phone is locked. You have to wait for 24hrs. to try again.");
			}
		}	
	}
