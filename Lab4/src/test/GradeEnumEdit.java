...
public class GradeEnumEdit {

	private final int score_sectionA, score_sectionB, score_final;

	public GradeEnumEdit() {
		this.score_sectionA = 0;
		this.score_sectionB = 0;
		this.score_final = 0;
	}

	public GradeEnumEdit(int score_sectionA, int score_sectionB, int score_final) {
